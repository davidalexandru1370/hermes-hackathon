...
const EmployesList = (props: any) => {
  ...
  return (
    <EnhancedTable
      ...
      reFetch={reFetch}
      numberOfExpiredDocuments={props.numberOfExpiredDocuments}
      setNumberOfExpiredDocuments={props.setNumberOfExpiredDocuments}
      employesInNeedOfNewDocuments={props.employesInNeedOfNewDocuments}
      setEmployeesInNeedOfNewDocuments={props.setEmployeesInNeedOfNewDocuments}
    ></EnhancedTable>
